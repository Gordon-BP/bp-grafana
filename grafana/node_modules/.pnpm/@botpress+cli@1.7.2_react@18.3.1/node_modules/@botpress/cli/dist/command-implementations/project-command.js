...
class ProjectCommand extends import_global_command.GlobalCommand {
  ...
  async _isBpLintDisabled(definitionPath) {
    const tsContent = await import_fs.default.promises.readFile(definitionPath, "utf-8");
  ...
  async readIntegrationConfigDefinition(config) {
  ...
  readProjectFile = async (filePath) => {
    ...
    return import_fs.default.promises.readFile(absoluteFilePath, "utf-8").catch((thrown) => {
