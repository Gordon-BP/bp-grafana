 ...
 */
export declare class UpstreamProviderError extends BaseApiError<502, UpstreamProviderType, 'The upstream provider returned an error or is currently unavailable.'> {
    constructor(message: string, error?: Error, id?: string);
}
